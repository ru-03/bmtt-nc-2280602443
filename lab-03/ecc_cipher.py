...
class MyApp(QMainWindow):
    def __init__(self):
        ...
        self.ui.bt_generate.clicked.connect(self.call_api_gen_keys)
        self.ui.bt_sign.clicked.connect(self.call_api_sign)
        self.ui.bt_verify.clicked.connect(self.call_api_verify)
